...
import { Search, Plus, Trash2, Edit2, X, MapPin, User, Warehouse as WarehouseIcon, Lock, CheckCircle, Info } from 'lucide-react';
import { Warehouse, User as UserType, Item, Movement } from '../types';
